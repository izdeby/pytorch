...
int64_t TypeDefault::output_nr(const Tensor & self) {
    ...
    if (self.has_names()) {
        AT_ERROR(
            "output_nr is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
std::tuple<Tensor,Tensor> TypeDefault::kthvalue(const Tensor & self, int64_t k, int64_t dim, bool keepdim) {
    ...
    if (self.has_names()) {
        AT_ERROR(
            "kthvalue is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor TypeDefault::logsumexp(const Tensor & self, IntArrayRef dim, bool keepdim) {
    ...
    if (self.has_names()) {
        AT_ERROR(
            "logsumexp is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor & TypeDefault::logsumexp_out(Tensor & out, const Tensor & self, IntArrayRef dim, bool keepdim) {
    ...
    if (out.has_names() || self.has_names()) {
        AT_ERROR(
            "logsumexp_out is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
#ifdef BUILD_NAMEDTENSOR
Tensor TypeDefault::mean(const Tensor & self, DimnameList dim, bool keepdim, c10::optional<ScalarType> dtype) {
#ifdef BUILD_NAMEDTENSOR
...
#endif
#ifdef BUILD_NAMEDTENSOR
Tensor & TypeDefault::mean_out(Tensor & out, const Tensor & self, DimnameList dim, bool keepdim, c10::optional<ScalarType> dtype) {
#ifdef BUILD_NAMEDTENSOR
...
std::tuple<Tensor &,Tensor &> TypeDefault::median_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim) {
    ...
    if (values.has_names() || indices.has_names() || self.has_names()) {
        AT_ERROR(
            "median_out is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
std::tuple<Tensor,Tensor> TypeDefault::mode(const Tensor & self, int64_t dim, bool keepdim) {
    ...
    if (self.has_names()) {
        AT_ERROR(
            "mode is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
std::tuple<Tensor &,Tensor &> TypeDefault::mode_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim) {
    ...
    if (values.has_names() || indices.has_names() || self.has_names()) {
        AT_ERROR(
            "mode_out is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor TypeDefault::detach(const Tensor & self) {
    ...
    if (self.has_names()) {
        AT_ERROR(
            "detach is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor & TypeDefault::detach_(Tensor & self) {
    ...
    if (self.has_names()) {
        AT_ERROR(
            "detach_ is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor & TypeDefault::atan2_(Tensor & self, const Tensor & other) {
    ...
    if (self.has_names() || other.has_names()) {
        AT_ERROR(
            "atan2_ is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor & TypeDefault::atan2_out(Tensor & out, const Tensor & self, const Tensor & other) {
    ...
    if (out.has_names() || self.has_names() || other.has_names()) {
        AT_ERROR(
            "atan2_out is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
Tensor TypeDefault::atan2(const Tensor & self, const Tensor & other) {
    ...
    if (self.has_names() || other.has_names()) {
        AT_ERROR(
            "atan2 is not yet supported with named tensors. Please drop names via "
            "`tensor = tensor.rename(None)`, call the op with an unnamed tensor, "
            "and set names on the result of the operation.");
    }
#endif
...
static auto registerer = torch::RegisterOperators()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyCatchAllKernel<Tensor (const Tensor &, c10::optional<ScalarType>), &TypeDefault::mean>()
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::mean.dim(Tensor self, int[1] dim, bool keepdim=False, *, ScalarType? dtype=None) -> Tensor")
    .impl_unboxedOnlyCatchAllKernel<Tensor (const Tensor &, IntArrayRef, bool, c10::optional<ScalarType>), &TypeDefault::mean>()
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::mean.out(Tensor self, int[1] dim, bool keepdim=False, *, ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)")
    .impl_unboxedOnlyCatchAllKernel<Tensor & (Tensor &, const Tensor &, IntArrayRef, bool, c10::optional<ScalarType>), &TypeDefault::mean_out>()
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  #ifdef BUILD_NAMEDTENSOR
  .op(torch::RegisterOperators::options()
