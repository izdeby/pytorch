...
static PyObject * THPVariable__dequantize_per_tensor(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_dequantize_per_tensor(Tensor input, double scale, int64_t zero_point, ScalarType dtype)",
  }, /*traceable=*/true);
  ...
  if (r.idx == 0) {
    return wrap(dispatch__dequantize_per_tensor(r.tensor(0), r.toDouble(1), r.toInt64(2), r.scalartype(3)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyMethodDef torch_functions[] = {
  ...
  {"_dequantize_per_tensor", (PyCFunction)(void(*)(void))THPVariable__dequantize_per_tensor, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
